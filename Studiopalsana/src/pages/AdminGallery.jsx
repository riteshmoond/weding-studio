...
export default function AdminGallery() {
  ...
  const load = () => api("/gallery").then(setItems).catch((e) => setMessage(e.message));
  useEffect(load, []);
